            ...
            {messages.length === 0 ? (
              <div className="flex items-center justify-center h-full">
                <div className="max-w-2xl mx-auto px-4">
                  <div className="bg-gradient-to-r from-primary-50 to-blue-50 rounded-lg border-2 border-primary-200 px-6 py-4">
                    <div className="flex items-start mb-3">
                      ...
                      <div className="ml-3">
                        <h3 className="text-lg font-bold text-gray-900 mb-2">Type or speak your message below</h3>
                        <p className="text-gray-700 mb-3">
                          You can type in the text box, click the microphone{' '}
                          <svg className="w-4 h-4 inline text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
