...
import { MarkdownLink, MarkdownImage, markdownPlugins, markdownBaseProps } from '../../utils/markdownComponents';
          ...
          {translation.context_note && (
            <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg p-3 sm:p-4 mt-4">
              <div className="text-sm text-amber-800 dark:text-amber-300">
                <strong>Note:</strong> <ReactMarkdown className="inline" {...markdownBaseProps}>{translation.context_note}</ReactMarkdown>
              </div>
            </div>
          )}
        </div>
