      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-gray-800 py-6 px-4 shadow-md sm:rounded-xl sm:px-10 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          ...
          <div className="mt-6">
            ...
            {/* Free AI Tools - inline links */}
            <div className="mt-4 flex justify-center gap-3 text-xs text-gray-500 dark:text-gray-400">
              <Link to="/tools/jargon" className="hover:text-gray-700 dark:hover:text-gray-300 underline">
                Jargon Translator
              </Link>
              <span>·</span>
              <Link to="/tools/coach" className="hover:text-gray-700 dark:hover:text-gray-300 underline">
                Conversation Coach
              </Link>
            </div>
          </div>
