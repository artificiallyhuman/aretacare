...
Supported: PDF, PNG, JPG, TXT (20MB max). Auto-categorizes into 12 categories.
...
Supported: MP3, M4A, WAV, WebM, OGG (20MB max). Auto-transcribes, categorizes, converts to MP3.
